...
BEGIN_MESSAGE_MAP(CPlanningDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_FORWARD_SEARCH, &CPlanningDlg::OnBnClickedButtonForwardSearch)		//基于前向搜索的方法
	ON_BN_CLICKED(IDC_BUTTON_BACKWARD_SEARCH, &CPlanningDlg::OnBnClickedButtonBackwardSearch)	//基于反向搜索的方法
END_MESSAGE_MAP()
