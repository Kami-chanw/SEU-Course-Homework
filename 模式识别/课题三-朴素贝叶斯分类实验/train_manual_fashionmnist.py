...
import pandas as pd
from utils import load_images, load_labels  # 假设你有相应的加载函数
...
def visualize_predictions(images, true_labels, pred_labels, num_samples=10):
    ...
    for i in range(num_samples):
        ...
        plt.axis('off')
    plt.tight_layout()
    plt.savefig(fname='./manual_fashion_bayes_mnist_figure')
...
results_df.to_csv('task1_fashionmnist_manual_test_predictions.csv', index=False)