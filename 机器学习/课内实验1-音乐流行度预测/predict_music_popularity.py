...
continous_attributes=[attr for attr in attributes \
                      if attr not in discrete_attributes]# 使用Python中的列表推导式导出数据集连续属性
...
print('R2-Score of Testing set', r2_score(train_y, train_prediction))
print('MSE of Test set', mean_squared_error(test_y, test_prediction))
print('R2-Score of Testing set', r2_score(test_y, test_prediction))
